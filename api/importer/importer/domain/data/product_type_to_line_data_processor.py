...
class ProductTypeToLineDataProcessor():
    ...
    def clean_data(self):
        self.processed_data = self.processed_data[['product type', 'product line']]
        self.processed_data.drop_duplicates('product type', inplace=True)
