...
class ProductLineToClassDataProcessor():
    ...
    def clean_data(self):
        self.processed_data = self.processed_data[['product line', 'product class']]
        self.processed_data.drop_duplicates('product line', inplace=True)
