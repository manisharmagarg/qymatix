...
class SalesRecordDataProcessor():
    ...
    def clean_data(self):
        # self.processed_data = self.processed_data[['account name', 'industry']]
        # self.processed_data.drop_duplicates('account name', inplace=True)
        pass
