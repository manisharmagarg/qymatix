...
class ProductType():
    ...
    def __init__(self, name):
        ...
        self._product_line_id = None #Column(ForeignKey('product_line.id'), nullable=False, index=True)
        ...
        self._product_line = None #relationship('ProductLine')
    ...
    def product_line_id(self, value: int):
