...
class ImportSalesRecordCommand(CommandInterface):
    ...
    @property
    def fqdn(self):
        module = "api.importer.importer.application.import_sales_record_handler"
        handler_class = "ImportSalesRecordHandler"
