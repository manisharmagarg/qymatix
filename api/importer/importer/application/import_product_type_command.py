...
class ImportProductTypeCommand(CommandInterface):
    ...
    @property
    def fqdn(self):
        module = "api.importer.importer.application.import_product_type_handler"
        handler_class = "ImportProductTypeHandler"
